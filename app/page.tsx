...
export default function HomePage() {
  ...
  return (
    <div id="home-page-root" className="overflow-x-hidden">
      ...
      {/* 1. HERO SECTION */}
      <section id="hero-section" className="relative bg-gradient-to-b from-[#1C1C1C] to-[#121212] pt-24 pb-20 lg:pt-36 lg:pb-32 text-white">
        {/* Soft atmospheric background lights */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#FF6B00]/10 rounded-full blur-3xl pointer-events-none"></div>
        <div className="absolute bottom-10 right-1/4 w-96 h-96 bg-orange-600/5 rounded-full blur-3xl pointer-events-none"></div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            
            {/* Sales Copy */}
            <div className="lg:col-span-7 space-y-8" id="hero-copy-col">
              ...
              <p className="text-gray-300 text-lg sm:text-xl font-normal leading-relaxed max-w-2xl">
                Empower your restaurant, retail outlet, pharmacy, or enterprise with high-performance billing systems, advanced real-time inventory management, custom web apps, and automated digital ecosystems. Designed for flawless scale.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 pt-2">
                <Link 
                  ...
                  className="bg-[#FF6B00] hover:bg-[#FF8C39] text-white px-8 py-4 rounded-xl text-base font-bold shadow-xl shadow-[#FF6B00]/20 hover:shadow-[#FF6B00]/30 transition-all text-center flex items-center justify-center space-x-2"
                >
                ...
                <a 
                  ...
                  className="bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white px-8 py-4 rounded-xl text-base font-bold transition-all text-center flex items-center justify-center space-x-2"
                >
            ...
            {/* Interactive Vector Mockup Panel */}
            <div className="lg:col-span-5 relative" id="hero-vector-col">
              <div className="w-full aspect-square max-w-[480px] mx-auto bg-gradient-to-tr from-[#FF6B00]/10 to-orange-600/5 rounded-3xl p-1 relative shadow-2xl">
                <div className="absolute inset-0 bg-white rounded-3xl border border-gray-100 p-6 flex flex-col justify-between overflow-hidden shadow-2xl animate-luxury-float text-[#1C1C1C]">
                  ...
                  <div className="flex items-center justify-between border-b border-gray-100 pb-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="ml-2 bg-gray-50 border border-gray-150 rounded px-2.5 py-0.5 text-[9px] text-gray-400 font-mono">chishtysmart.solutions</span>
                    </div>
                    <span className="text-[10px] bg-[#FF6B00]/10 text-[#FF6B00] px-2.5 py-1 rounded-full font-bold uppercase tracking-wider">
                      Live Sales Feed
                    </span>
                  </div>
                  ...
                  <div className="my-6 space-y-4">
                    <div className="flex items-baseline justify-between">
                      <div>
                        <span className="text-xs text-gray-400 block font-semibold uppercase tracking-wider font-mono">Total Revenue (Daily)</span>
                        <span className="text-2xl sm:text-3xl font-black font-mono text-[#1C1C1C]">PKR 842,910</span>
                      </div>
                      <span className="text-xs text-emerald-600 font-bold bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-100">+18.4%</span>
                    </div>

                    {/* Faux grid lines & bar */}
                    <div className="h-28 flex items-end justify-between gap-2 pt-4 bg-gray-50/50 rounded-xl p-3 border border-gray-100/60">
                      <div className="w-full bg-[#FF6B00]/20 rounded-t-md h-[40%] transition-all duration-500 hover:bg-[#FF6B00]/50"></div>
                      <div className="w-full bg-orange-200 rounded-t-md h-[65%]"></div>
                      <div className="w-full bg-orange-300 rounded-t-md h-[55%]"></div>
                      <div className="w-full bg-orange-400 rounded-t-md h-[85%]"></div>
                      <div className="w-full bg-[#FF6B00] rounded-t-md h-[100%] shadow-lg shadow-[#FF6B00]/20"></div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 border-t border-gray-100 pt-4">
                    ...
                    <div className="flex items-center justify-between text-xs font-medium text-gray-500">
                      <span>Offline Databases</span>
                      <span className="text-[#FF6B00] font-bold">Synchronized (SQLite)</span>
                    </div>
                  </div>
                ...
                <div className="absolute -bottom-4 -right-4 bg-white p-4 rounded-2xl shadow-xl border border-gray-100 flex items-center gap-3">
                  ...
                  <span className="text-xs font-black text-gray-800 uppercase tracking-widest font-mono">POS Terminal Live</span>
                </div>
              </div>
            </div>
      ...
      <section id="trusted-by" className="py-12 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-center text-xs font-semibold text-gray-400 uppercase tracking-widest mb-8">
            Empowering Operations for Industry Leaders & Modern Brands
          </p>
          <div className="grid grid-cols-2 md:grid-cols-6 gap-8 items-center opacity-60 hover:opacity-80 transition-opacity">
            {trustedBrands.map((brand, idx) => (
              <div key={idx} className="text-center font-bold text-gray-600 text-sm tracking-tight border border-gray-100 py-3 rounded-lg bg-gray-50/50">
                {brand}
              </div>
            ))}
          </div>
      ...
      {/* 7. REAL-TIME STATS PANEL */}
      <section id="stats-section" className="py-20 bg-gray-50 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8" id="stats-grid">
            {stats.map((stat, idx) => (
              <div key={idx} className="text-center space-y-2">
                <span className="text-3xl sm:text-5xl font-black text-[#FF6B00] block font-mono">
                  {stat.value}
                </span>
                <span className="text-xs text-gray-500 font-bold tracking-wider uppercase block">
                  {stat.label}
                </span>
              </div>
            ))}
      ...
      <section id="portfolio-preview" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-16" id="portfolio-header">
            <div className="space-y-4 max-w-2xl">
              <span className="text-xs font-semibold text-[#FF6B00] uppercase tracking-wider bg-[#FF6B00]/10 px-3 py-1 rounded-full inline-block">
                Deployed Case Studies
              </span>
              <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-gray-900">
                Pristine Custom Deployments
              </h2>
            </div>
            <Link 
              id="view-portfolio-preview-cta"
              href="/portfolio" 
              className="text-sm font-bold text-gray-900 hover:text-[#FF6B00] flex items-center mt-4 md:mt-0"
            >
              <span>Explore Deployed Projects Directory</span>
              <ArrowRight className="w-4 h-4 ml-1.5" />
            </Link>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-12" id="portfolio-preview-grid">
            {portfolioPreviews.map((port, idx) => (
              <div key={idx} className="space-y-6 group">
                <div className="aspect-video bg-gray-50 border border-gray-100 rounded-3xl overflow-hidden relative shadow-sm hover:shadow-md transition-shadow">
                  <div className="absolute inset-0 bg-gradient-to-tr from-[#FF6B00]/5 to-transparent"></div>
                  <div className="absolute bottom-6 left-6 bg-[#1C1C1C] text-[#FF6B00] px-4 py-1.5 rounded-full font-mono text-xs font-bold">
                    {port.metric}
                  </div>
                </div>
      ...
      <section id="testimonials-section" className="py-24 bg-gray-50/50 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-4" id="testimonials-header">
            <span className="text-xs font-semibold text-[#FF6B00] uppercase tracking-wider bg-[#FF6B00]/10 px-3 py-1 rounded-full">
              Client Feedback
            </span>
            <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-gray-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8" id="testimonials-grid">
            {testimonials.map((test, idx) => (
              <div key={idx} className="bg-white border border-gray-100 rounded-2xl p-8 relative shadow-sm">
                <p className="text-gray-700 text-sm italic leading-relaxed mb-6">
                  &ldquo;{test.quote}&rdquo;
                </p>
                <div className="flex items-center space-x-4">
                  <img src={test.image} alt={test.author} className="w-10 h-10 rounded-full bg-gray-100" referrerPolicy="no-referrer" />
                  <div>
