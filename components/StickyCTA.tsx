      ...
      {visible && (
        ...
        >
          ...
          <button
            ...
            className="absolute -top-1.5 -right-1.5 bg-[#1C1C1C] border border-white/10 hover:border-white/20 text-gray-400 hover:text-white p-1 rounded-full shadow-lg transition-colors"
          ...
          {/* Icon */}
          <div className="w-10 h-10 bg-[#FF6B00]/10 border border-[#FF6B00]/20 rounded-xl flex items-center justify-center text-[#FF6B00] shrink-0">
          ...
          <div className="min-w-0 pr-2">
            <div className="flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 bg-[#FF6B00] rounded-full animate-ping"></span>
          ...
          <Link
            ...
            className="bg-[#FF6B00] hover:bg-[#FF8C39] text-white font-extrabold text-xs px-3.5 py-2.5 rounded-xl flex items-center space-x-1 shadow-lg shadow-[#FF6B00]/20 hover:shadow-[#FF6B00]/30 transition-all shrink-0"
          >
            <span>Book Now</span>
